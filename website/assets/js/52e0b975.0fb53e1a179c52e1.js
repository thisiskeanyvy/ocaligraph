    ...
    [502], {
        8864: function(e, t, r) {
            ...
            var i = r(8699),
                ...
                a = null,
                l = class e {
                    constructor(e = "Pass", t = new i.Scene, r = s) {
                    ...
                    set fullscreenMaterial(e) {
                        ...
                        null !== t ? t.material = e : ((t = new i.Mesh(function() {
                            if (null === a) {
                                ...
                                void 0 !== (a = new i.BufferGeometry).setAttribute ? (a.setAttribute("position", new i.BufferAttribute(e, 3)), a.setAttribute("uv", new i.BufferAttribute(t, 2))) : (a.addAttribute("position", new i.BufferAttribute(e, 3)), a.addAttribute("uv", new i.BufferAttribute(t, 2)))
                            }
                            return a
                    ...
                    dispose() {
                        for (let t of Object.keys(this)) {
                            let r = this[t];
                            (r instanceof i.WebGLRenderTarget || r instanceof i.Material || r instanceof i.Texture || r instanceof e) && this[t].dispose()
                        }
                    }
                },
                o = class extends l {
                ...
                u = Number(i.REVISION.replace(/\D+/g, ""));

            function h(e) {
                return u < 154 ? e.replace("colorspace_fragment", "encodings_fragment") : e
            }
            var c = "varying vec2 vUv;void main(){vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}",
                d = class extends i.ShaderMaterial {
                    constructor() {
                        super({
                            ...
                            vertexShader: c
                        }), this.fragmentShader = h(this.fragmentShader)
                    }
                    set inputBuffer(e) {
                ...
                f = class extends l {
                    constructor(e, t = !0) {
                        super("CopyPass"), this.fullscreenMaterial = new d, this.needsSwap = !1, this.renderTarget = e, void 0 === e && (this.renderTarget = new i.WebGLRenderTarget(1, 1, {
                    ...
                    initialize(e, t, r) {
                        void 0 !== r && (this.renderTarget.texture.type = r, r !== i.UnsignedByteType ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : null !== e && e.outputColorSpace === i.SRGBColorSpace && (this.renderTarget.texture.colorSpace = i.SRGBColorSpace))
                    }
                },
                p = new i.Color,
                v = class extends l {
                    ...
                    render(e, t, r, i, n) {
                        let s = this.overrideClearColor,
                            ...
                            o = null !== s,
                            u = a >= 0;
                        o ? (e.getClearColor(p), e.setClearColor(s, u ? a : l)) : u && e.setClearAlpha(a), e.setRenderTarget(this.renderToScreen ? null : t), e.clear(this.color, this.depth, this.stencil), o ? e.setClearColor(p, l) : u && e.setClearAlpha(l)
                    }
                },
                m = class extends l {
                    constructor(e, t) {
                    ...
                    render(e, t, r, i, n) {
                        let s = e.getContext(),
                            ...
                            u = this.clearPass,
                            h = this.inverted ? 0 : 1;
                        a.color.setMask(!1), a.depth.setMask(!1), a.color.setLocked(!0), a.depth.setLocked(!0), a.stencil.setTest(!0), a.stencil.setOp(s.REPLACE, s.REPLACE, s.REPLACE), a.stencil.setFunc(s.ALWAYS, h, 4294967295), a.stencil.setClear(1 - h), a.stencil.setLocked(!0), this.clearPass.enabled && (this.renderToScreen ? u.render(e, null) : (u.render(e, t), u.render(e, r))), this.renderToScreen ? e.setRenderTarget(null) : (e.setRenderTarget(t), e.render(l, o), e.setRenderTarget(r)), e.render(l, o), a.color.setLocked(!1), a.depth.setLocked(!1), a.stencil.setLocked(!1), a.stencil.setFunc(s.EQUAL, 1, 4294967295), a.stencil.setOp(s.KEEP, s.KEEP, s.KEEP), a.stencil.setLocked(!0)
                    }
                },
                g = class {
                    constructor(e = null, {
                        ...
                        this.renderer = null, this.inputBuffer = this.createBuffer(t, r, s, i), this.outputBuffer = this.inputBuffer.clone(), this.copyPass = new f, this.depthTexture = null, this.passes = [], this.timer = new n, this.autoRenderToScreen = !0, this.setRenderer(e)
                    }
                    get multisampling() {
                    ...
                    setRenderer(e) {
                        if (this.renderer = e, null !== e) {
                            ...
                            for (let s of (n === i.UnsignedByteType && e.outputColorSpace === i.SRGBColorSpace && (this.inputBuffer.texture.colorSpace = i.SRGBColorSpace, this.outputBuffer.texture.colorSpace = i.SRGBColorSpace, this.inputBuffer.dispose(), this.outputBuffer.dispose()), e.autoClear = !1, this.setSize(t.width, t.height), this.passes)) s.initialize(e, r, n)
                        }
                    }
                    ...
                    createBuffer(e, t, r, n) {
                        let s = this.renderer,
                            ...
                            o = new i.WebGLRenderTarget(a.width, a.height, l);
                        return n > 0 && (o.ignoreDepthForMultisampleCopy = !1, o.samples = n), r === i.UnsignedByteType && null !== s && s.outputColorSpace === i.SRGBColorSpace && (o.texture.colorSpace = i.SRGBColorSpace), o.texture.name = "EffectComposer.Buffer", o.texture.generateMipmaps = !1, o
                    }
                    setMainScene(e) {
                    ...
                    render(e) {
                        ...
                        let n = this.renderer,
                            ...
                            l = this.outputBuffer,
                            u = !1;
                        for (let h of (void 0 === e && (this.timer.update(), e = this.timer.getDelta()), this.passes)) h.enabled && (h.render(n, a, l, e, u), h.needsSwap && (u && (s.renderToScreen = h.renderToScreen, t = n.getContext(), (r = n.state.buffers.stencil).setFunc(t.NOTEQUAL, 1, 4294967295), s.render(n, a, l, e, u), r.setFunc(t.EQUAL, 1, 4294967295)), i = a, a = l, l = i), h instanceof m ? u = !0 : h instanceof o && (u = !1))
                    }
                    setSize(e, t, r) {
                        let n = this.renderer,
                ...
                y = class {
                    constructor() {
                        ...
                        ]), this.defines = new Map, this.uniforms = new Map, this.blendModes = new Map, this.extensions = new Set, this.attributes = S.NONE, this.varyings = new Set, this.uvTransformation = !1, this.readDepth = !1, this.colorSpace = i.LinearSRGBColorSpace
                    }
                },
                T = !1,
                U = class {
                ...
                w = class extends i.EventDispatcher {
                ...
                R = class extends i.EventDispatcher {
                    constructor(e, t = 1) {
                ...
                b = class extends i.ShaderMaterial {
                    constructor(e = new i.Vector4) {
                        ...
                        }), this.fragmentShader = h(this.fragmentShader), this.setTexelSize(e.x, e.y), this.kernelSize = M.MEDIUM
                    }
                    set inputBuffer(e) {
                        this.uniforms.inputBuffer.value = e
                    }
                ...
                D = class extends l {
                    constructor({
                        ...
                        let l = this.resolution = new w(this, s, a, t);
                        l.addEventListener("change", e => this.setSize(l.baseWidth, l.baseHeight)), this._blurMaterial = new b, this._blurMaterial.kernelSize = e, this.copyMaterial = new d
                    }
                    getResolution() {
                    ...
                    render(e, t, r, i, n) {
                        ...
                        for (let t = 0, r = h.length; t < r; ++t) {
                            let r = (1 & t) == 0 ? l : o;
                            u.kernel = h[t], u.inputBuffer = c.texture, e.setRenderTarget(r), e.render(s, a), c = r
                        }
                        this.fullscreenMaterial = this.copyMaterial, this.copyMaterial.inputBuffer = c.texture, e.setRenderTarget(this.renderToScreen ? null : r), e.render(s, a)
                    }
                    setSize(e, t) {
                ...
                _ = class extends l {
                    constructor({
                        ...
                        super("LuminancePass"), this.fullscreenMaterial = new z(r, t), this.needsSwap = !1, this.renderTarget = e, void 0 === this.renderTarget && (this.renderTarget = new i.WebGLRenderTarget(1, 1, {
                            depthBuffer: !1
                        }), this.renderTarget.texture.name = "LuminancePass.Target");
                        let u = this.resolution = new w(this, l, o, n);
                    ...
                    initialize(e, t, r) {
                        void 0 !== r && r !== i.UnsignedByteType && (this.renderTarget.texture.type = r, this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1")
                    }
                },
                C = class extends i.ShaderMaterial {
                    constructor() {
                        super({
                ...
                F = class extends i.ShaderMaterial {
                    constructor() {
                        super({
                            ...
                            uniforms: {
                                inputBuffer: new i.Uniform(null),
                                supportBuffer: new i.Uniform(null),
                                texelSize: new i.Uniform(new i.Vector2),
                                radius: new i.Uniform(.85)
                            },
                            blending: i.NoBlending,
                            toneMapped: !1,
                            depthWrite: !1,
                ...
                I = class extends l {
                    constructor() {
                        super("MipmapBlurPass"), this.needsSwap = !1, this.renderTarget = new i.WebGLRenderTarget(1, 1, {
                            depthBuffer: !1
                        }), this.renderTarget.texture.name = "Upsampling.Mipmap0", this.downsamplingMipmaps = [], this.upsamplingMipmaps = [], this.downsamplingMaterial = new C, this.upsamplingMaterial = new F, this.resolution = new i.Vector2
                    }
                    get texture() {
                        return this.renderTarget.texture
                    }
                    ...
                    render(e, t, r, i, n) {
                        ...
                        for (let t = 0, r = u.length; t < r; ++t) {
                            let r = u[t];
                            l.setSize(c.width, c.height), l.inputBuffer = c.texture, e.setRenderTarget(r), e.render(s, a), c = r
                        }
                        this.fullscreenMaterial = o;
                        for (let t = h.length - 1; t >= 0; --t) {
                            let r = h[t];
                            o.setSize(c.width, c.height), o.inputBuffer = c.texture, o.supportBuffer = u[t].texture, e.setRenderTarget(r), e.render(s, a), c = r
                        }
                    }
                    setSize(e, t) {
                        let r = this.resolution;
                        ...
                        let i = r.width,
                            n = r.height;
                        for (let e = 0, t = this.downsamplingMipmaps.length; e < t; ++e) i = Math.round(.5 * i), n = Math.round(.5 * n), this.downsamplingMipmaps[e].setSize(i, n), e < this.upsamplingMipmaps.length && this.upsamplingMipmaps[e].setSize(i, n)
                    }
                    initialize(e, t, r) {
                        if (void 0 !== r) {
                            let t = this.downsamplingMipmaps.concat(this.upsamplingMipmaps);
                            for (let e of t) e.texture.type = r;
                            if (r !== i.UnsignedByteType) this.downsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1", this.upsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
                            else if (null !== e && e.outputColorSpace === i.SRGBColorSpace)
                                for (let e of t) e.texture.colorSpace = i.SRGBColorSpace
                        }
                    }
                    dispose() {
                ...
                P = class extends i.EventDispatcher {
                    constructor(e, t, {
                        attributes: r = S.NONE,
                        ...
                        super(), this.name = e, this.renderer = null, this.attributes = r, this.fragmentShader = t, this.vertexShader = o, this.defines = s, this.uniforms = a, this.extensions = l, this.blendMode = new R(n), this.blendMode.addEventListener("change", e => this.setChanged()), this._inputColorSpace = i.LinearSRGBColorSpace, this._outputColorSpace = i.NoColorSpace
                    }
                    get inputColorSpace() {
                    ...
                    dispose() {
                        for (let e of Object.keys(this)) {
                            let t = this[e];
                            (t instanceof i.WebGLRenderTarget || t instanceof i.Material || t instanceof i.Texture || t instanceof l) && this[e].dispose()
                        }
                    }
                },
                N = class extends P {
                    constructor({
                        ...
                        luminanceSmoothing: r = .025,
                        mipmapBlur: n = !1,
                        intensity: s = 1,
                        radius: a = .85,
                        levels: l = 8,
                        kernelSize: o = M.LARGE,
                        resolutionScale: u = .5,
                        width: h = w.AUTO_SIZE,
                        ...
                        super("BloomEffect", "#ifdef FRAMEBUFFER_PRECISION_HIGH\nuniform mediump sampler2D map;\n#else\nuniform lowp sampler2D map;\n#endif\nuniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec4 texel=texture2D(map,uv);outputColor=vec4(texel.rgb*intensity,texel.a);}", {
                            ...
                            kernelSize: o
                        }), this.luminancePass = new _({
                            colorOutput: !0
                        }), this.luminanceMaterial.threshold = t, this.luminanceMaterial.smoothing = r, this.mipmapBlurPass = new I, this.mipmapBlurPass.enabled = n, this.mipmapBlurPass.radius = a, this.mipmapBlurPass.levels = l, this.uniforms.get("map").value = n ? this.mipmapBlurPass.texture : this.renderTarget.texture;
                        let p = this.resolution = new w(this, d, f, u);
                    ...
                    update(e, t, r) {
                        ...
                        n.enabled ? (n.render(e, t), this.mipmapBlurPass.enabled ? this.mipmapBlurPass.render(e, n.renderTarget) : this.blurPass.render(e, n.renderTarget, i)) : this.mipmapBlurPass.enabled ? this.mipmapBlurPass.render(e, t) : this.blurPass.render(e, t, i)
                    }
                    setSize(e, t) {
                        let r = this.resolution;
                    ...
                    initialize(e, t, r) {
                        this.blurPass.initialize(e, t, r), this.luminancePass.initialize(e, t, r), this.mipmapBlurPass.initialize(e, t, r), void 0 !== r && (this.renderTarget.texture.type = r, null !== e && e.outputColorSpace === i.SRGBColorSpace && (this.renderTarget.texture.colorSpace = i.SRGBColorSpace))
                    }
                },
                H = class extends l {
                    constructor(e, t, r = null) {
                        super("RenderPass", e, t), this.needsSwap = !1, this.clearPass = new v, this.overrideMaterialManager = null === r ? null : new U(r), this.ignoreBackground = !1, this.skipShadowMapUpdate = !1, this.selection = null
                    }
                    set mainScene(e) {
                        this.scene = e
                    }
                    ...
                    render(e, t, r, i, n) {
                        ...
                        null !== l && a.layers.set(l.getLayer()), this.skipShadowMapUpdate && (e.shadowMap.autoUpdate = !1), (this.ignoreBackground || null !== this.clearPass.overrideClearColor) && (s.background = null), this.clearPass.enabled && this.clearPass.render(e, t), e.setRenderTarget(c), null !== this.overrideMaterialManager ? this.overrideMaterialManager.render(e, s, a) : e.render(s, a), a.layers.mask = o, s.background = u, e.shadowMap.autoUpdate = h
                    }
                },
                ...
                O = class extends l {
                    constructor({
                        ...
                        let l = new G;
                        l.normalBuffer = e, this.fullscreenMaterial = l, this.needsDepthTexture = !0, this.needsSwap = !1, this.renderTarget = new i.WebGLRenderTarget(1, 1, {
                        ...
                        let o = this.resolution = new w(this, s, a, t);
            ...
            var V = class extends l {
                    constructor(e, ...t) {
                        super("EffectPass"), this.fullscreenMaterial = new L(null, null, null, e), this.listener = e => this.handleEvent(e), this.effects = [], this.setEffects(t), this.skipRendering = !1, this.minTime = 1, this.maxTime = Number.POSITIVE_INFINITY, this.timeScale = 1
                    }
                    set mainScene(e) {
                    ...
                    updateMaterial() {
                        ...
                        for (let r of this.effects)
                            if (r.blendMode.blendFunction === E.DST) e.attributes |= r.getAttributes() & S.DEPTH;
                            else if ((e.attributes & r.getAttributes() & S.CONVOLUTION) != 0) throw Error(`Convolution effects cannot be merged (${r.name})`);
                        else ! function(e, t, r) {
                            let n = t.getFragmentShader(),
                                s = t.getVertexShader(),
                                a = void 0 !== n && /mainImage/.test(n),
                                l = void 0 !== n && /mainUv/.test(n);
                            if (r.attributes |= t.getAttributes(), void 0 === n) throw Error(`Missing fragment shader (${t.name})`);
                            if (l && (r.attributes & S.CONVOLUTION) != 0) throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);
                            if (a || l) {
                                let o = /\w+\s+(\w+)\([\w\s,]*\)\s*{/g,
                                    u = r.shaderParts,
...
`, r.uvTransformation = !0), null !== s && /mainSupport/.test(s)) {
                                    for (let t of (p += `	${e}MainSupport(` + (/mainSupport *\([\w\s]*?uv\s*?\)/.test(s) ? "vUv);\n" : ");\n"), s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g)))
                                        for (let e of t[1].split(/\s*,\s*/)) r.varyings.add(e), v.add(e), m.add(e);
                                    for (let e of s.matchAll(o)) m.add(e[1])
                                }
                                for (let e of n.matchAll(o)) m.add(e[1]);
...
`
                ...
                W = class extends l {
                    constructor(e, t, {
                        ...
                        super("NormalPass"), this.needsSwap = !1, this.renderPass = new H(e, t, new i.MeshNormalMaterial);
                        let u = this.renderPass;
                        u.ignoreBackground = !0, u.skipShadowMapUpdate = !0;
                        let h = u.getClearPass();
                        h.overrideClearColor = new i.Color(7829503), h.overrideClearAlpha = 1, this.renderTarget = r, void 0 === this.renderTarget && (this.renderTarget = new i.WebGLRenderTarget(1, 1, {
                            minFilter: i.NearestFilter,
                            magFilter: i.NearestFilter
                        }), this.renderTarget.texture.name = "NormalPass.Target");
                        let c = this.resolution = new w(this, l, o, n);
            ...
            new Float32Array(3), new Float32Array(3), new Float32Array(3), new Float32Array(3), new Float32Array(3), new Float32Array(3), new Float32Array([0, 0, 0]), new Float32Array([1, 0, 0]), new Float32Array([1, 1, 0]), new Float32Array([1, 1, 1]), new Float32Array([0, 0, 0]), new Float32Array([1, 0, 0]), new Float32Array([1, 0, 1]), new Float32Array([1, 1, 1]), new Float32Array([0, 0, 0]), new Float32Array([0, 0, 1]), new Float32Array([1, 0, 1]), new Float32Array([1, 1, 1]), new Float32Array([0, 0, 0]), new Float32Array([0, 1, 0]), new Float32Array([1, 1, 0]), new Float32Array([1, 1, 1]), new Float32Array([0, 0, 0]), new Float32Array([0, 1, 0]), new Float32Array([0, 1, 1]), new Float32Array([1, 1, 1]), new Float32Array([0, 0, 0]), new Float32Array([0, 0, 1]), new Float32Array([0, 1, 1]), new Float32Array([1, 1, 1]), new Float32Array(2), new Float32Array(2), new Float32Array([0, -.25, .25, -.125, .125, -.375, .375]), new Float32Array([0, 0]), new Float32Array([.25, -.25]), new Float32Array([-.25, .25]), new Float32Array([.125, -.125]), new Float32Array([-.125, .125]), new Uint8Array([0, 0]), new Uint8Array([3, 0]), new Uint8Array([0, 3]), new Uint8Array([3, 3]), new Uint8Array([1, 0]), new Uint8Array([4, 0]), new Uint8Array([1, 3]), new Uint8Array([4, 3]), new Uint8Array([0, 1]), new Uint8Array([3, 1]), new Uint8Array([0, 4]), new Uint8Array([3, 4]), new Uint8Array([1, 1]), new Uint8Array([4, 1]), new Uint8Array([1, 4]), new Uint8Array([4, 4]), new Uint8Array([0, 0]), new Uint8Array([1, 0]), new Uint8Array([0, 2]), new Uint8Array([1, 2]), new Uint8Array([2, 0]), new Uint8Array([3, 0]), new Uint8Array([2, 2]), new Uint8Array([3, 2]), new Uint8Array([0, 1]), new Uint8Array([1, 1]), new Uint8Array([0, 3]), new Uint8Array([1, 3]), new Uint8Array([2, 1]), new Uint8Array([3, 1]), new Uint8Array([2, 3]), new Uint8Array([3, 3]), X(0, 0, 0, 0), new Float32Array([0, 0, 0, 0]), X(0, 0, 0, 1), new Float32Array([0, 0, 0, 1]), X(0, 0, 1, 0), new Float32Array([0, 0, 1, 0]), X(0, 0, 1, 1), new Float32Array([0, 0, 1, 1]), X(0, 1, 0, 0), new Float32Array([0, 1, 0, 0]), X(0, 1, 0, 1), new Float32Array([0, 1, 0, 1]), X(0, 1, 1, 0), new Float32Array([0, 1, 1, 0]), X(0, 1, 1, 1), new Float32Array([0, 1, 1, 1]), X(1, 0, 0, 0), new Float32Array([1, 0, 0, 0]), X(1, 0, 0, 1), new Float32Array([1, 0, 0, 1]), X(1, 0, 1, 0), new Float32Array([1, 0, 1, 0]), X(1, 0, 1, 1), new Float32Array([1, 0, 1, 1]), X(1, 1, 0, 0), new Float32Array([1, 1, 0, 0]), X(1, 1, 0, 1), new Float32Array([1, 1, 0, 1]), X(1, 1, 1, 0), new Float32Array([1, 1, 1, 0]), X(1, 1, 1, 1), new Float32Array([1, 1, 1, 1])
        }
    }
]);